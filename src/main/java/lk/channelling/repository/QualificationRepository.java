...
/**
 * Repository interface for managing and accessing Qualification information.
 *
 * <p>This interface defines methods for retrieving, updating, and managing Qualification data
...
public interface QualificationRepository extends JpaRepository<Qualification, Long> {
     ...
     *
     * @param id must not be {@literal null}. The id of the Qualification.
     * @return the Qualification details.
     */
     ...
     *
     * @param status the status of the Qualification. It should either ACTIVE or INACTIVE.
     * @return the list of countries.
     */
    List<Qualification> findByStatus(Status status);

    /**
     * Returns the qualification by the qualificationLevel id.
     *
     * @param qualificationLevelId The qualificationLevel id

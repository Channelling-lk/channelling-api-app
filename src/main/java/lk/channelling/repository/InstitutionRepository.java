...
/**
 * Repository interface for managing and accessing Institution information.
 *
 * <p>This interface defines methods for retrieving, updating, and managing Institution data
...
public interface InstitutionRepository extends JpaRepository<Institution, Long> {
     ...
     *
     * @param id must not be {@literal null}. The id of the Institution.
     * @return the Institution details.
     */
     ...
     *
     * @param status the status of the Institution. It should either ACTIVE or INACTIVE.

...
/**
 * Repository interface for managing and accessing City information.
 *
 * <p>This interface defines methods for retrieving, updating, and managing City data
...
public interface CityRepository extends JpaRepository<City, Long> {
     ...
     *
     * @param status the status of the City. It should either ACTIVE or INACTIVE.
